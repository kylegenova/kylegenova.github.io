...
\begin{itemize}
  \item Pretraining core contributor for Gemini, Gemini Omni, and Genie, focusing on the 3D understanding and generation capabilities of frontier models.
  \item Lead contributor for a 20+ person collaboration between the Gemini Vision and Geo teams, which has landed multiple datasets improving Gemini’s spatial understanding capabilities.
  \item Own creation of the majority of the 3D data for a model training research effort; contributed multiple petabytes of pretraining data across multiple GDM frontier models.
\end{itemize}

\entryhead{Google DeepMind — Senior Research Scientist}{May 2024 -- Oct.\ 2025}{Foundational Research Unit \hfill New York, NY}
\begin{itemize}
  \item Led Geo's Foundational Features project, a 2-year 3D model training effort to build a world-scale 3D feature representation supporting open-vocabulary scene-understanding queries for the Google Maps team.
  \item Contributed pretraining data to Gemini~3, improving its depth, correspondence, detection, and geospatial capabilities.
