...
\begin{itemize}
  ...
  \item Lead the 20+ contributor collaboration between Gemini pretraining and Google Geo, which has landed multiple datasets improving Gemini's spatial understanding; serve as Gemini pretraining's point person for Geo.
  \item Contributed multiple petabytes of pretraining data across multiple frontier models; own creation of the majority of the 3D generation data for an unannounced model training effort.
\end{itemize}
...
\begin{itemize}
  \item Published and productionized 2D3DNet, the most used 3D understanding model across Google Maps since 2021 --- driving over 30 million map updates and supporting routing, HD maps, 3D reconstruction, and indoor Immersive View. Over one quadrillion 3D points served.
\end{itemize}
...
\begin{itemize}\small
  \pub{Image Generators are Generalist Vision Learners}{Valentin Gabeur, Shangbang Long, Songyou Peng, Paul Voigtlaender, \ldots, \me, \ldots, Kaiming He, Thomas Funkhouser, Jean-Baptiste Alayrac, Radu Soricut (25 authors)}{arXiv, 2026}
