...
\begin{itemize}
  \item Pretraining core contributor for Gemini, Gemini Omni, and Genie workstreams, focusing on the 3D understanding and generation capabilities of frontier models.
  \item Lead the 20+ contributor collaboration between Gemini pretraining and Google Geo, which has landed multiple
datasets improving Gemini’s spatial understanding evals; serve as Gemini pretraining’s point person for Geo.
  \item Own creation of the majority of the 3D generation data for an unannounced model training effort; have contributed multiple petabytes of pretraining data across multiple frontier models.
\end{itemize}

\entryhead{Google DeepMind — Senior Research Scientist}{May 2024 -- Oct.\ 2025}{Foundational Research Unit \hfill New York, NY}
\begin{itemize}
  \item Contributed geospatial pretraining data to Gemini~3, the first model to surpass human experts at geoguessing.
...
\begin{itemize}\small
  \pub{Image Generators are Generalist Vision Learners (Vision Banana)}{Valentin Gabeur, Shangbang Long, Songyou Peng, Paul Voigtlaender, \ldots, \me, \ldots, Kaiming He, Thomas Funkhouser, Jean-Baptiste Alayrac, Radu Soricut (25 authors)}{arXiv, 2026}
